...
/**
 * Class that manages the invocation of the thread that will run the taskScheduler for the Communication step.
 ...
 * Currently, this class is mostly identical to ProcessingManager and InputManager. They were kept separate as
...
class CommunicatingManager {
    ...
    CommunicatingManager(TaskScheduler taskScheduler){
