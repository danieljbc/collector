...
/**
 * Class that manages the invocation of the thread that will run the taskScheduler for the Processing step.
 ...
 * Currently, this class is mostly identical to InputManager and CommunicationManager. They were kept separate as
...
class ProcessingManager {
    ...
    ProcessingManager(TaskScheduler taskScheduler){
